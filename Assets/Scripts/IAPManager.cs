...
public class IAPManager : MonoBehaviour, IStoreListener
{
	...
	public static IAPManager InstanceIAP { get; set;}
	...
	public static string PRODUCT_NO_ADS=    "com.pugballgames.products.noads";   
...
//		var builder = ConfigurationBuilder.Instance(starndar
	...
	public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
	{
		...
		if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_NO_ADS, StringComparison.Ordinal))
		{
			...
			if (this.SLManager.pData.ads)
				this.SLManager.SaveStateAds (false);
		}else 
		{
